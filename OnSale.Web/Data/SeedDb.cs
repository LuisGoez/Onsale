...
namespace OnSale.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1248556322", "Luis", "Goez", "Goez8434@gmail.com", "3105226985", "Calle Luna nueva cr#14", UserType.Admin);
        ...
        private async Task CheckProductsAsync()
        {
            ...
            {
                User user = await _userHelper.GetUserAsync("Goez8434@gmail.com");
